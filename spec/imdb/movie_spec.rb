...
describe "Imdb::Movie" do
  ...
  describe "valid movie" do
    ...
    # Get Die Hard (1988)
    let(:movie) { Imdb::Movie.new("0095016") }
    ...
    it "should find the tagline" do
      ...
      movie.tagline.should == "He's the only chance anyone has got."
  ...
  describe "plot" do
    ...
    it "should not have a 'more' link in the plot" do
      ...
      movie.plot.should eql("An unnamed doctor has always had everything he's ever wanted, but that has only made him develop more extreme and depraved needs. He kidnaps a young couple in the prime of their life ...")
    end
  end
...
#  end
  ...
  describe "with no submitted poster" do
    ...
    # Grotesque (2009)
    let(:movie) { Imdb::Movie.new("0330508") }
  ...
  describe "with an old poster (no @@)" do
    ...
    # Pulp Fiction (1994)
    let(:movie) { Imdb::Movie.new("0110912") }
  ...
  it "should have an original_title" do
